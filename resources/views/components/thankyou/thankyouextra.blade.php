<main class="relative max-w-screen-3xl mx-auto overflow-hidden">
    ...
    <section class="relative 2xl:flex max-w-screen-xl mx-auto pb-20 xl:py-24 z-20">
        ...
        <div class="xl:flex xl:flex-col xl:justify-center xl:items-center 2xl:justify-start 2xl:items-baseline">
            <div class="text-gray-750 bg-white xl:w-835 px-4 py-8 xl:pl-12 xl:pt-9 xl:pb-24 xl:mb-24 2xl:mb-28 xl:rounded-4xl xl:shadow-big-cards text-center xl:text-left">
                ...
                <div class="flex justify-center items-center xl:justify-start xl:items-baseline mt-20">
                    <a href="#" class="flex flex-col xl:flex-row justify-center items-center xl:py-6 xl:px-9 xl:w-226 rounded-2xl-1/2 mr-12 xl:mr-10 xl:shadow-small-cards">
                    ...
                    <a href="https://www.bill.com/" target="_blank" class="flex flex-col xl:flex-row justify-center items-center xl:py-6 xl:px-9 xl:w-226 rounded-2xl-1/2 xl:shadow-small-cards">
            ...
            <div class="block my-12 xl:m-0 2xl:hidden xl:w-835">
                <img class="xl:rounded-4xl" src="{{ asset('img/table-meeting.png') }}" alt="Business People at table">
            </div>

            <div class="text-gray-750 bg-white xl:w-835 px-20 sm:px-4 xl:px-4 py-8 xl:pl-12 xl:pt-9 xl:pb-24 xl:mt-24 2xl:mt-0 xl:rounded-4xl xl:shadow-big-cards">
                <h3 class="font-bold text-3xl text-center xl:text-left">Related Resources</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-x-8 lg:grid-cols-3 xl:grid-cols-2 gap-y-8 mt-20">
                    <a href="https://www.bill.com/" target="_blank" class="p-4 w-full xl:w-80 h-40 rounded-2xl-1/2 xl:shadow-long-cards" style="background-image: linear-gradient(to bottom right, #FF2C49, #C171FF);">
                    ...
                    <a href="https://www.bill.com/" target="_blank" class="p-4 w-full xl:w-80 h-40 rounded-2xl-1/2 xl:shadow-long-cards" style="background-image: linear-gradient(to bottom right, #95FF2C, #717AFF);">
                        <div class="text-white text-right text-xl">
                            <i class="fa fa-external-link" aria-hidden="true"></i>
                        </div>
                        <p class="font-medium text-lg text-white">Lorem ipsum
                    ...
                    <a href="https://www.bill.com/" target="_blank" class="p-4 w-full xl:w-80 h-40 rounded-2xl-1/2 xl:shadow-long-cards" style="background-image: linear-gradient(to bottom right, #632CFF, #71FFEC);">
                        <div class="text-white text-right text-xl">
                            <i class="fa fa-external-link" aria-hidden="true"></i>
                        </div>
                        <p class="font-medium text-lg text-white">Lorem ipsum
        ...
        <div class="relative hidden 2xl:block mt-28 w-full">
